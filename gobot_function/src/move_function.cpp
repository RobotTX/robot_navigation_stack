...
/*
	#Move along object frame x-axis:
		*Positive - goal_x = object_pose.x + dis*std::sin(object_pose.yaw), goal_y = object_pose.y - dis*std::sin(object_pose.yaw);
		*Negative - goal_x = object_pose.x - dis*std::cos(object_pose.yaw), goal_y = object_pose.y + dis*std::sin(object_pose.yaw);

	#Move along object frame y-axis:
		*Positive - goal_x = object_pose.x + dis*std::cos(object_pose.yaw), goal_y = object_pose.y + dis*std::sin(object_pose.yaw);
		*Negative - goal_x = object_pose.x - dis*std::cos(object_pose.yaw), goal_y = object_pose.y - dis*std::sin(object_pose.yaw);
*/
